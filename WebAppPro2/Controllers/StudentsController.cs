...
namespace WebAppPro2.Controllers
{
    ...
    {
        private RainbowSchoolEntities db = new RainbowSchoolEntities();
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,Gender,ClassId,SubjectId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,StudentName,Gender,ClassId,SubjectId")] Student student)
        {
            if (ModelState.IsValid)
            {
